      ...
      {loading && (
        <div className="flex flex-col items-center justify-center py-12 bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
          ...
          <p className="text-gray-500 dark:text-gray-500 text-sm mt-1">
            Searching for "{username}" on GitHub
          </p>
        </div>
      )}

      {/* Error State */}
      {error && !loading && error.includes("not found") && (
        <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-xl p-8 text-center">
          ...
          <p className="text-red-700 dark:text-red-400 mb-4">
            Looks like we can't find the user "<span className="font-semibold">{username}</span>" on GitHub.
          </p>
